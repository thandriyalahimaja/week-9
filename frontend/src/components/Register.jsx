...
function Register() {
  ...
  const onUserRegister = async (newUser) => {
    ...
    try {
      ...
      //add all fields except file to FormData object
        ...
        <form onSubmit={handleSubmit(onUserRegister)}>
          ...
          <div className="sm:flex gap-4 mb-4">
            <div className="flex-1">
              ...
              <input type="text" {...register("firstName")} placeholder="First name" className={inputClass} autoComplete="given-name" />
            </div>
            <div className="flex-1">
              <label className={labelClass}>Last Name</label>
              <input type="text" {...register("lastName")} placeholder="Last name" className={inputClass} autoComplete="family-name" />
            </div>
          </div>
          ...
          <div className={formGroup}>
            ...
            <input type="email" {...register("email")} placeholder="you@example.com" className={inputClass} autoComplete="email" />
          </div>

          {/* Password */}
          <div className={formGroup}>
            <label className={labelClass}>Password</label>
            <input type="password" {...register("password")} placeholder="Min. 8 characters" className={inputClass} autoComplete="new-password" />
          </div>
          ...
          <div className={formGroup}>
            ...
            {preview && (
              <div className="mt-3">
                <img src={preview} alt="Profile Preview" className="w-20 h-20 object-cover rounded-full" />
              </div>
            )}
          </div>
